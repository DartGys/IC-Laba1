...
namespace FootBallWebLaba1.Controllers
{
    public class PlayersController : Controller
    {
        ...
        {
            var footBallBdContext = _context.Players.Include(p => p.Club);
        ...
        public async Task<IActionResult> Create([Bind("PlayerId,PlayerName,PlayerNumber,PlayerPosition,PlayerSalary,PlayerBirthDate,ClubId")] Player player)
        {
